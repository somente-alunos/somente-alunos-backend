...
import { Class_GetStudentPagamentoFeito } from "./endpoint_student/get_student_pagamento_feito"
...
async function Function_handleRequest(Parameter_request: Request, Parameter_env: Env, Parameter_context: ExecutionContext): Promise<Response> {
	...
	// GET /get/student/pagamento-feito
	else if (Const_pathName === '/get/student/pagamento-feito' && Const_method === 'GET') {
		return await Class_GetStudentPagamentoFeito.main(Parameter_request, Parameter_env, Parameter_context)
	}
	...
	else if (Const_pathName === '/post/student/sair' && Const_method === 'POST') {
		return await Class_PostStudentSair.main(Parameter_request, Parameter_env, Parameter_context)
	}

	// POST /post/admin/sair
	else if (Const_pathName === '/post/admin/sair' && Const_method === 'POST') {
		return await Class_PostAdminSair.main(Parameter_request, Parameter_env, Parameter_context)
	}
